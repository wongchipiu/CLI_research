...
- **了解 Codex 如何参与开发、审阅与受限研究说明：**读 [Codex 集成与落地需求](CODEX_INTEGRATION.md)。它定义职责、日常使用、权限边界和分期验收，不能替代量化评价或交易授权。
- **查看本次验收审计结论：**读 [2026-09-06 验收审计](ACCEPTANCE_AUDIT_2026-09-06.md)，区分离线交付与真实环境待验收项。
...
- **查以前研究过什么：**到 [research/](research/)；查自动生成的月度策略汇总到 [monthly_review/](monthly_review/)。其中包括 [Alphabet 2026 Q2 财报前瞻与 AI 供应链研究快照](research/2026-07-22-alphabet-ai-earnings-supply-chain.md)。
...
| [CODEX_INTEGRATION.md](CODEX_INTEGRATION.md) | Codex 的功能定位、使用方式、与两仓的边界及后续落地需求 | Codex skills、SDK、MCP、权限或接入阶段变化时 |
